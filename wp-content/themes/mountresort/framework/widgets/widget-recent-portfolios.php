<?php
class Mount_Resort_Portfolio_Widget extends WP_Widget {
	#1.constructor
	function __construct() {
		$widget_options = array("classname"=>'widget_popular_entries', 'description'=>esc_html__('To list out portfolio items', 'mountresort'));
		parent::__construct(false,MOUNT_RESORT_THEME_NAME.esc_html__(' Portfolio','mountresort'),$widget_options);
	}
	...
	function widget($args, $instance) {
		...
		echo "<div class='recent-portfolio-widget'><ul>";
			 ...
			 if($the_query->have_posts()) :
			 	...
			 	echo "<li>".esc_html__('No Portfolio Entries found','mountresort')."</li>";
			 endif;
			 wp_reset_postdata();
	 	echo "</ul></div>";			 
		echo ($after_widget);
