<?php $post_meta = get_post_meta($post->ID,'_dt_post_settings',TRUE);
	...
	$post_classes = array('blog-entry','single','format-'.$format, $post_style );
...
<article id="post-<?php the_ID();?>" <?php post_class($post_classes);?>>
	...
	<?php if( $post_style == "entry-date-left"):?>
			...
			<div class="entry-details">
				...
				<?php edit_post_link( esc_html__( ' Edit ','mountresort' ) ); ?>
			</div><!-- .entry-details -->
			...
			<div class="entry-details">
				...
				<div class="entry-meta">
					...
					<div class="author <?php echo esc_attr( $show_author_meta );?>">
						/ <i class="pe-icon pe-user"> </i>
						<a href="<?php echo get_author_posts_url(get_the_author_meta('ID'));?>" title="<?php esc_attr_e('View all posts by ', 'mountresort'); echo get_the_author();?>">
...
<?php # Post Author Information Box
	...
	if( !empty($post_author_box) ):?>
		...
		<section class="author-info">
        	<h2><?php esc_html_e('About Author','mountresort');?></h2>
			<div class="thumb">
