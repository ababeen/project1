...
get_header();
    ...
    <section id="primary" class="<?php echo esc_attr( $page_layout );?>"><?php
			...
			while( have_posts() ):
                ...
                <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>><?php 
					...
					wp_link_pages( array(	
						...
						'pagelink' =>	'%',
						'echo'	=>	1 ) );
					edit_post_link( esc_html__( ' Edit ','mountresort' ) );?>
        ...
        <?php $post_layout = isset( $tpl_default_settings['portfolio-post-layout'] ) ? $tpl_default_settings['portfolio-post-layout'] : "one-half-column";
			...
			$allow_space =  $tpl_default_settings['portfolio-grid-space'] ? "with-space" : "no-space";
			...
			if( (sizeof($categories) > 1) && $tpl_default_settings["filter"] ) :
				$post_class .= " all-sort";?>
                <div class="dt-sc-portfolio-sorting <?php echo esc_attr($post_style);?>">
                	<a href="#" class="active-sort" title="" data-filter=".all-sort"><?php esc_html_e('All','mountresort');?></a>
			...
			if($the_query->have_posts()):
            	...
            	<div class="dt-sc-portfolio-container <?php echo esc_attr($allow_space);?>"><?php 
					while( $the_query->have_posts() ):
						...
						if( $tpl_default_settings["filter"] ):
                                ...
                                <div class="image-overlay">
                                    ...
                                    <?php elseif( $post_style == "type1" || $post_style == "type2" || $post_style == "type5" || $post_style == "type7" || $post_style == "type8"):?>
                                            ...
                                            <div class="image-overlay-details">
												<h2><a href="<?php the_permalink();?>" title="<?php printf( esc_attr__('Permalink to %s','mountresort'), the_title_attribute('echo=0'));?>"><?php 
													the_title();?></a></h2><?php
												if( $post_style != "type2"):
													if( $post_style == "type7" ):
            ...
            <div class="pagination blog-pagination">
            	<?php echo mount_resort_pagination($the_query); ?>
            </div><!-- **Pagination** --> 
        <!-- Portfolio Template -->        
