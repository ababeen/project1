    ...
    <div class="dt-sc-two-fifth column">
        <div class="dt-sc-tabs-horizontal-frame-container event-meta-tab">
          <ul class="dt-sc-tabs-horizontal-frame">
            <li><a href="#" class="current"><?php esc_html_e('Details', 'mountresort'); ?></span></a></li>
            <li><a href="#"><?php esc_html_e('Organizer', 'mountresort'); ?></a></li>
            <li><a href="#"><?php esc_html_e('Venue', 'mountresort'); ?></a></li>
          </ul>
