...
<div id="item-actions">
	...
	<?php if ( bp_group_is_visible() ) : ?>
		...
		if ( bp_group_has_moderators() ) :
			...
			<h3><?php esc_html_e( 'Group Mods' , 'mountresort' ); ?></h3>
...
<div id="item-header-content">
	...
	<span class="activity"><?php printf( __( 'active %s', 'mountresort' ), bp_get_group_last_active() ); ?></span>
	...
	<h3><?php esc_html_e( 'Group Admins', 'mountresort' ); ?></h3>
