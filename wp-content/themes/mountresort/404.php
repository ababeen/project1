        ...
        <div class="center-content-wrapper">
            <div class="center-content"><?php
                ...
                elseif( cs_get_option( 'enable-404message' ) ):
                    echo '<div class="error-box square"><div class="error-box-inner"><h3>'.esc_html__('Oops!', 'mountresort').'</h3><h2>404</h2><h4>'.esc_html__('Page Not Found', 'mountresort').'</h4></div></div>';
                    echo '<div class="dt-sc-hr-invisible-xsmall"></div>';
                    echo '<p>'.esc_html__("It seems you've venured too far.", 'mountresort').'</p><p>'.esc_html__('Click here to go to home page.', 'mountresort').'</p>';
                    echo '<div class="dt-sc-hr-invisible-xsmall"></div>';
                    echo '<a class="dt-sc-button filled small" target="_blank" href="'.esc_url(home_url('/')).'">'.esc_html__('Back to Home','mountresort').'</a>';
                endif; ?>
            </div>
        </div>
    </div>    
