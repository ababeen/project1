...
MOUNT_RESORT_Kirki::add_section( 'dt_site_skin_section', array(
	'title' => __( 'Site Skin', 'mountresort' ),
	'priority' => 23
) );
	...
	MOUNT_RESORT_Kirki::add_field( $config, array(
		...
		'label'    => __( 'Predefined Skin ?', 'mountresort' ),
		'section'  => 'dt_site_skin_section',
		'priority' => 1,
		'default'  => mount_resort_defaults('use-predefined-skin'),
		'choices'  => array(
	...
	MOUNT_RESORT_Kirki::add_field( $config, array(
		...
		'label'    => __( 'Skin', 'mountresort' ),
		'section'  => 'dt_site_skin_section',
		'default' => mount_resort_defaults('predefined-skin' ),
		'multiple' => 1,
		'priority' => 2,
		...
		'choices' => array(
			'blue'			=>	esc_attr__('Blue','mountresort'),			'brown'			=>	esc_attr__('Brown','mountresort'),
			'cadetblue'		=>	esc_attr__('Cadet Blue','mountresort'),	'chilipepper'	=>	esc_attr__('Chili Pepper','mountresort'),
			'cyan'			=>	esc_attr__('Cyan','mountresort'),			'darkgolden'	=>	esc_attr__('Dark Golden','mountresort'),
			'deeporange'	=>	esc_attr__('Deep Orange','mountresort'),	'deeppurple'	=>	esc_attr__('Deep Purple','mountresort'),
			'green'			=>	esc_attr__('Green','mountresort'),			'lime'			=>	esc_attr__('Lime','mountresort'),
			'magenta'		=>	esc_attr__('Magenta','mountresort'),		'orange'		=>	esc_attr__('Orange','mountresort'),
			'pink'			=>	esc_attr__('Pink','mountresort'),			'purple'		=>	esc_attr__('Purple','mountresort'),
			'red'			=>	esc_attr__('Red','mountresort'),			'skyblue'		=>	esc_attr__('Sky Blue','mountresort'),
			'teal'			=>	esc_attr__('Teal','mountresort'),			'turquoise'		=>	esc_attr__('Turquoise','mountresort'),
			'wisteria'		=>	esc_attr__('Wisteria','mountresort'),		'yellow'		=>	esc_attr__('Yellow','mountresort'),
		)
	));
	...
	MOUNT_RESORT_Kirki::add_field( $config, array(
		...
		'label'    => __( 'Primary Color', 'mountresort' ),
		'section'  => 'dt_site_skin_section',
		'priority' => 3,
		'choices' => array( 'alpha' => true ),
		'default'  => mount_resort_defaults('primary-color'),
		'active_callback' => array(
		...
		'output' => array(
			...
			array( 'element' => '.dt-sc-menu-sorting a:hover, .dt-sc-menu-sorting a.active-sort, .dt-sc-training-details h6, .dt-sc-fitness-diet:hover .dt-sc-fitness-diet-details h5, table.fit-Diet-table th strong, .dt-sc-hotel-room-single-metadata ul li, .dt-sc-hotel-room .dt-sc-hotel-room-details ul li, /* New */ .bordered-content-box h2, .bordered-content-box h4, .dt-sc-hotel-room .dt-sc-hotel-room-type-3 p span.price', 'property' => 'color' ),


			# Primary BG Color - Base
			array( 'element' => 'table th, input[type="submit"], button, input[type="reset"], .loader', 'property' => 'background-color' ),
...
.menu-icons-wrapper.rounded-icons .search a span:hover, .menu-icons-wrapper.rounded-icons .cart a span:hover, .menu-icons-wrapper .cart sup', 'property' => 'background-color' ),
			...
			array( 'element' => '
				...
				.post-nav-container .post-next-link a:hover, .post-nav-container .post-prev-link a:hover, .page-link > span, .page-link a:hover, .post-edit-link:hover, .vc_inline-link:hover, .pagination ul li a:hover, .pagination ul li span, /* New */ .default.blog-entry:hover .entry-details', 'property' => 'background-color' ),			
			...
			array( 'element' => 'ul.side-nav li a:hover:before, ul.side-nav > li.current_page_item > a:before, ul.side-nav > li > ul > li.current_page_item > a:before, ul.side-nav > li > ul > li > ul > li.current_page_item > a:before, .dt-sc-small-separator, .dt-sc-diamond-separator, .dt-sc-titled-box h6.dt-sc-titled-box-title, .carousel-arrows a:hover, .dt-sc-images-wrapper .carousel-arrows a:hover, .diamond-narrow-square-border li:hover:before, .dt-sc-sociable.hexagon-with-border li, .dt-sc-skin-highlight, .dt-sc-skin-highlight.extend-bg-fullwidth-left:after, .dt-sc-skin-highlight.extend-bg-fullwidth-right:after, .two-color-section:before, .dt-sc-readmore-plus-icon:hover:before, .dt-sc-readmore-plus-icon:hover:after, .dt-sc-contact-details-on-map .map-switch-icon, .dt-sc-content-with-hexagon-shape, .dt-sc-hexagons li .dt-sc-hexagon-overlay, .available-domains li .tdl:before, .available-domains li:hover .dt-sc-button, .domain-search-container .domain-search-form, /* New */ .dt-sc-newsletter-section.type1 h2:before, .dt-sc-newsletter-section.type1 h2:after, .dt-carousel-navigation a:hover', 'property' => 'background-color' ),
			...
			array( 'element' => '.menu-active-border-with-arrow  #main-menu > ul.menu > li.current_page_item > a:before, .menu-active-border-with-arrow  #main-menu > ul.menu > li.current_page_ancestor > a:before, .menu-active-border-with-arrow  #main-menu > ul.menu > li.current-menu-item > a:before, .menu-active-border-with-arrow  #main-menu > ul.menu > li.current-menu-ancestor > a:before, /* New */ #main-menu .megamenu-child-container > ul.sub-menu > li > a, #main-menu .megamenu-child-container > ul.sub-menu > li > .nolink-menu', 'property' => 'border-bottom-color' ),
			...
			array( 'element' => '.dt-sc-counter.type3 .icon-wrapper:before, .dt-sc-counter.type3.diamond-square, .dt-sc-counter.type5:hover:before, .dt-sc-counter.type5:hover:after, .dt-sc-counter.type6, .dt-sc-counter.type6 .dt-sc-couter-icon-holder:before, .dt-sc-counter.type1:hover', 'property' => 'border-color' ),
			...
			array( 'element' => '.dt-sc-up-arrow:before, .dt-sc-image-caption .dt-sc-image-wrapper .icon-wrapper:before, .dt-sc-triangle-wrapper.alter:hover .dt-sc-triangle-content:before, .dt-sc-content-with-hexagon-shape:before, .dt-sc-tabs-horizontal-frame-container.type3 ul.dt-sc-tabs-horizontal-frame > li > a.current, .dt-sc-tabs-horizontal-frame-container.type4 ul.dt-sc-tabs-horizontal-frame > li > a.current, /* New */ .dt-sc-pr-tb-col.type1 .dt-sc-tb-content li', 'property' => 'border-bottom-color' ),
	...
	MOUNT_RESORT_Kirki::add_field( $config, array(
		...
		'label'    => __( 'Secondary Color', 'mountresort' ),
		'section'  => 'dt_site_skin_section',
		'priority' => 4,
		'choices' => array( 'alpha' => true ),
		'default'  => mount_resort_defaults('secondary-color'),
		'active_callback' => array(
			array( 'setting' => 'use-predefined-skin', 'operator' => '==', 'value' => '0' )
		),
		'output' => array(
	...
	MOUNT_RESORT_Kirki::add_field( $config, array(
		...
		'label'    => __( 'Tertiary Color', 'mountresort' ),
		'section'  => 'dt_site_skin_section',
		'priority' => 5,
		'choices' => array( 'alpha' => true ),
		'default'  => mount_resort_defaults('tertiary-color'),
		'active_callback' => array(
			array( 'setting' => 'use-predefined-skin', 'operator' => '==', 'value' => '0' )
		),
		'output' => array(
			...
			# /* New * / Blog Default
			array( 'element' => '.default.blog-entry .entry-details', 'property' => 'background-color' ),
			
			# Tertiary BG Color - Miscellaneous/Shortcodes
			array( 'element' => '.dt-sc-triangle-title:before, .dt-sc-icon-box.type10 .icon-wrapper:after, /* New */ .skin-light-highlight, .dt-sc-pr-tb-col.type1, tbody tr:nth-child(2n+1) td, .dt-sc-title.script-with-sub-title:before', 'property' => 'background-color' ),	
			...
			array( 'element' => '.woo-type18 ul.products li.product:hover .product-wrapper:after, /* New */ .dt-sc-counter.type1', 'property' => 'border-color' ),	
	...
	MOUNT_RESORT_Kirki::add_field( $config, array(
		...
		'label'    => __( 'Site BG Color', 'mountresort' ),
		'section'  => 'dt_site_skin_section',
		'output' => array(
			array( 'element' => '
		...
		'choices' => array( 'alpha' => true ),
		'default'  => mount_resort_defaults('body-bg-color'),
	));
	...
	MOUNT_RESORT_Kirki::add_field( $config, array(
		...
		'label'    => __( 'Site Content Color', 'mountresort' ),
		'section'  => 'dt_site_skin_section',
		'output' => array(
			array( 'element' => 'body' , 'property' => 'color' )
		),
		'choices' => array( 'alpha' => true ),
		'default'  => mount_resort_defaults('body-content-color'),
	));
	...
	MOUNT_RESORT_Kirki::add_field( $config, array(
		...
		'label'    => __( 'Site Link Color', 'mountresort' ),
		'section'  => 'dt_site_skin_section',
		'output' => array(
			array( 'element' => 'a' , 'property' => 'color' )
		),
		'choices' => array( 'alpha' => true ),
		'default'  => mount_resort_defaults('body-a-color'),
	));
	...
	MOUNT_RESORT_Kirki::add_field( $config, array(
		...
		'label'    => __( 'Site Link Hover Color', 'mountresort' ),
		'section'  => 'dt_site_skin_section',
		'output' => array(
			array( 'element' => 'a:hover' , 'property' => 'color' )
		),
		'choices' => array( 'alpha' => true ),
		'default'  => mount_resort_defaults('body-a-hover-color'),
	));					