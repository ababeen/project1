...
if (! class_exists ( 'DTRoomCustomPostType' )) {
	...
	class DTRoomCustomPostType {
		...
		function dt_wp_enqueue_scripts() {
			...
			wp_enqueue_script ( 'dt-fancybox', plugins_url ('designthemes-rooms-addon') . '/js/fancybox.js', array (), false, true );
			wp_enqueue_script ( 'dt-rooms-addon-scripts', plugins_url ('designthemes-rooms-addon') . '/js/hotel.js', array (), false, true );
			wp_enqueue_style ( 'dt-fancybox', plugins_url ('designthemes-rooms-addon') . '/css/jquery.fancybox.css', array (), false, 'all' );
