...
<div class="wrap about-wrap">
	...
	<div id="fsqm-whats-new">
		...
		<p><?php _e( '<strong>Version 3.7.3</strong> Upgrade MailChimp to v3 and Backend bug fixes.' ) ?></p>
		<p><?php _e( '<strong>Version 3.7.2</strong> RTL Improvement and various bug fixes.' ) ?></p>
		<p><?php _e( '<strong>Version 3.7.1</strong> Mailerlite & Enormail integration with improvements of various form elements.' ) ?></p>
		<p><?php _e( '<strong>Version 3.7.0</strong> reCaptcha Support, Conditional Administrative Email, Vertical Sliders, RTL support, Post meta based prefil, Equals to validation along with WooCommerce Improvements' ) ?></p>
