...
class IPT_FSQM_Popup_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		$form_urls = IPT_FSQM_Form_Elements_Static::standalone_permalink_parts( $form_id );
		...
		$config_json->style = $instance['button_style'];
		$config_json->header = str_replace( '%FORM%', $form->name, $instance['button_header'] );
		$config_json->subtitle = $instance['button_subtitle'];
		$config_json->icon = $instance['button_icon'];
		$config_json->width = $instance['button_width'];
