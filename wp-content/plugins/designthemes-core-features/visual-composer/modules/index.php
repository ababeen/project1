...
$attributes = array(
    ...
    'description' => esc_html__( 'Enter letter spacing eg:10px.', 'designthemes-core' )
);
...
$attributes = array(
    ...
    'value' => array(
    	...
    	__( 'Initial', 'js_composer' ) => 'initial',
    	__( 'Inherit', 'js_composer' ) => 'inherit',
    ),
    'description' => esc_html__( 'Choose text transform.', 'designthemes-core' )
);
vc_add_param( 'vc_custom_heading', $attributes );?>