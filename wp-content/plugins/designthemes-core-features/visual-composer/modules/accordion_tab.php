...
function dt_sc_accordion_tab_vc_map() {
	vc_map( array(
		"name" => esc_html__( "Section", 'designthemes-core' ),
		...
		"params" => array(
			array(
				...
				'param_name' => 'title',
				'value' => esc_html__( 'Section', 'designthemes-core' ),
				'description' => esc_html__( 'Enter accordion section title', 'designthemes-core' )
			)
		),
